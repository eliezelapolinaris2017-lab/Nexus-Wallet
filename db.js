const DB = (() => {
  ...
  async function clearAll(){
    await new Promise((resolve, reject) => {
      const t = _db.transaction(["clients","visits","services","contracts","settings"], "readwrite");
      ["clients","visits","services","contracts","settings"].forEach(n => t.objectStore(n).clear());
